...
your_favorite_word = "bamboozle"

puts "My favorite word is bamboozle"
...
puts "MY FAVORITE WORD IS bamboozle".upcase 
...
puts "There are #{letter_count} in #{big_word}" "supercalifragilisticexpialidocious".length
